...
if [ ! -f word-vectors/arabic/parsed.${DAY}.csv ]; then
    ...
    rsync -avzr vacc1:/users/c/d/cdanfort/scratch/twitter/daily-wordcounts-arabic/parsed.${DAY}.csv word-vectors
	...
	python transform10kPolyGlot.py ${DAY} arabic
    ...
    echo "word-vectors/arabic/parsed.${DAY}.csv found"
fi
