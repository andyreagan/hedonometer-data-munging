...
if __name__ == '__main__':
    ...
    while currDay <= end:
        ...
        try:
            ...
            wordarrayst = stopper(wordarray,labMTvector,labMTwordList,ignore=["lynch","thirsty","pakistan","india","nigga","niggas","niggaz","nigger"])
            prevwordarrayst = stopper(prevwordarray,labMTvector,labMTwordList,ignore=["lynch","thirsty","pakistan","india","nigga","niggas","niggaz","nigger"])
