...
if __name__ == "__main__":
    ...
    while currDay <= end:
        ...
        try:
            f = codecs.open(
                "word-vectors/{1}/{0}-sum.csv".format(currDay.strftime("%Y-%m-%d"), lang),
                "r",
                "utf8",
            )
            ...
            f.close()
            print(
                "reading word-vectors/{1}/{0}".format(currDay.strftime("%Y-%m-%d-prev7.csv"), lang)
            )
            f = codecs.open(
                "word-vectors/{1}/{0}-prev7.csv".format(currDay.strftime("%Y-%m-%d"), lang),
                "r",
                "utf8",
            )
